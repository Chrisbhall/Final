...
export default function Buildings(props) {
  ...
  function onConfirm(){
   ...
   let map1 = props.buildings.map(b => {
    return <Building key={b.id} id={b.id} address={b.address} lease_expiray={b.lease_expiray} renewal_notice_due={b.renewal_notice_due} photo={b.photo_url} description={b.description} onEdit={onEdit} onDelete={onDelete} onDetails={onDetails}/>
  });
